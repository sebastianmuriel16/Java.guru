...
* The original package name 'guru.springframework.spring-6-icecold-service' is invalid and this project uses 'guru.springframework.spring_6_icecold_service' instead.
