package guru.springframework.spring_6_cool_service.listeners;
...
import guru.springframework.spring_6_cool_service.config.KafkaConfig;
...
@SpringBootTest
@EmbeddedKafka(controlledShutdown = true,topics = {KafkaConfig.DRINK_REQUEST_COOL_TOPIC}, partitions = 1)
