package guru.spring_reactive_mongodb.webfn;

import guru.spring_reactive_mongodb.domain.Beer;
import guru.spring_reactive_mongodb.model.BeerDTO;
import guru.spring_reactive_mongodb.services.IBeerServiceImplTest;
import guru.spring_reactive_mongodb.web.fn.BeerRouterConfig;
...
class BeerEndpointTest {
    ...
    void testPatchIdNotFound() {
        webTestClient.patch()
                ...
                .body(Mono.just(IBeerServiceImplTest.getTestbeer()), BeerDTO.class)
                .exchange()
    ...
    void testCreateBeerBadData() {
        Beer testBeer = IBeerServiceImplTest.getTestbeer();
